...
site1,site2,site3,site4=spacex_df['Launch Site'].unique().tolist()
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(min=0, max=10000, step=100,
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        labels={'class':'No of sussessful launches'})
        return fig
    else:
        site_df=filtered_df[filtered_df['Launch Site']==entered_site].drop(['Launch Site'],axis=1).value_counts().to_frame().reset_index()
        print(site_df)
